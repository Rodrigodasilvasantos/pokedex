        ...
        <div className="card">
              ...
              <div className="col-7">
                <div className="float-right">
                  {this.state.types.map(type => (
                    <span key={type} className="badge badge-secondary badge-pill mr1"
                    style={{
          ...
          <div className="card-body">
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <h6 className="float-left">{(this.state.height / 3.2808).toFixed(2)} Metros.</h6>
              </div>
            </div>
            <div className="row">
              <div className="col-md-6">
              ...
              <div className="col-md-6">
                <h6 className="float-left">{(this.state.weight / 2.2046).toFixed(2)} Kgs.</h6>
              </div>
            </div>
            <div className="row">
              <div className="col-md-6">
            ...
            <div className="row">
              <div className="col-md-6">
                <h6 className="float-right">Taxa de Gênero:</h6>
              </div>
              <div className="col-md-6">
                <div className="progress">
                  <div 
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <h6 className="float-right">Quantidade de Passos para Chocar:</h6>
                    </div>
                    <div className="col-md-6">
